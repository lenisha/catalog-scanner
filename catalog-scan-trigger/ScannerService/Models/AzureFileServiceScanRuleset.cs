...
namespace ScannerBabylonService.Models
{
    ...
    [Newtonsoft.Json.JsonObject("AzureFileService")]
    [JsonTransformation]
    public partial class AzureFileServiceScanRuleset : ScanRuleset
    {
        /// <summary>
        /// Initializes a new instance of the AzureFileServiceScanRuleset
        /// class.
        /// </summary>
        ...
        /// class.
        /// </summary>
        public AzureFileServiceScanRuleset(string id = default(string), string name = default(string), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? lastModifiedAt = default(System.DateTime?), IList<string> excludedSystemClassifications = default(IList<string>), IList<string> includedCustomClassificationRuleNames = default(IList<string>), string description = default(string), AzureFileServiceScanRulesetPropertiesScanningRule scanningRule = default(AzureFileServiceScanRulesetPropertiesScanningRule))
            : base(id, name)
        {
            CreatedAt = createdAt;
        ...
        public AzureFileServiceScanRulesetPropertiesScanningRule ScanningRule { get; set; }
