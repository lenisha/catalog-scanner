...
namespace ScannerBabylonService.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AzureCosmosDbScanRuleset class.
        /// </summary>
        ...
        /// Initializes a new instance of the AzureCosmosDbScanRuleset class.
        /// </summary>
        public AzureCosmosDbScanRuleset(string id = default(string), string name = default(string), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? lastModifiedAt = default(System.DateTime?), IList<string> excludedSystemClassifications = default(IList<string>), IList<string> includedCustomClassificationRuleNames = default(IList<string>), string description = default(string))
            : base(id, name)
        {
            CreatedAt = createdAt;
