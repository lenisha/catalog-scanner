...
namespace ScannerBabylonService.Models
{
    ...
    [Newtonsoft.Json.JsonObject("AzureSqlDatabaseManagedInstanceConnectionString")]
    [JsonTransformation]
    public partial class AzureSqlDatabaseManagedInstanceConnectionStringScan : Scan
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AzureSqlDatabaseManagedInstanceConnectionStringScan class.
        /// </summary>
        public AzureSqlDatabaseManagedInstanceConnectionStringScan()
        {
            CustomInit();
        }
        ...
        /// AzureSqlDatabaseManagedInstanceConnectionStringScan class.
        /// </summary>
        public AzureSqlDatabaseManagedInstanceConnectionStringScan(string id = default(string), string name = default(string), string scanRulesetName = default(string), int? workers = default(int?), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? lastModifiedAt = default(System.DateTime?), string serverEndpoint = default(string), string databaseName = default(string), string username = default(string), string password = default(string))
            : base(id, name)
        {
