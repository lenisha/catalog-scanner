...
namespace ScannerBabylonService.Models
{
    ...
    public partial class AdlsGen2ScanningRule
    {
        /// <summary>
        /// Initializes a new instance of the AdlsGen2ScanningRule class.
        /// </summary>
        public AdlsGen2ScanningRule()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the AdlsGen2ScanningRule class.
        /// </summary>
        public AdlsGen2ScanningRule(IList<string> fileExtensions = default(IList<string>))
        {
