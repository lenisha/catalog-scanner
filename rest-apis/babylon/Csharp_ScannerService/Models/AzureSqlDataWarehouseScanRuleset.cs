...
namespace ScannerBabylonService.Models
{
    ...
    [Newtonsoft.Json.JsonObject("AzureSqlDataWarehouse")]
    [JsonTransformation]
    public partial class AzureSqlDataWarehouseScanRuleset : ScanRuleset
    {
        /// <summary>
        /// Initializes a new instance of the AzureSqlDataWarehouseScanRuleset
        /// class.
        /// </summary>
        ...
        /// class.
        /// </summary>
        public AzureSqlDataWarehouseScanRuleset(string id = default(string), string name = default(string), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? lastModifiedAt = default(System.DateTime?), IList<string> excludedSystemClassifications = default(IList<string>), IList<string> includedCustomClassificationRuleNames = default(IList<string>), string description = default(string))
            : base(id, name)
        {
            CreatedAt = createdAt;
