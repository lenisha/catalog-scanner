...
namespace ScannerBabylonService.Models
{
    ...
    public partial class AzureSqlDatabaseManagedInstanceScanRuleset : ScanRuleset
    {
        ...
        /// AzureSqlDatabaseManagedInstanceScanRuleset class.
        /// </summary>
        ...
        /// AzureSqlDatabaseManagedInstanceScanRuleset class.
        /// </summary>
        public AzureSqlDatabaseManagedInstanceScanRuleset(string id = default(string), string name = default(string), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? lastModifiedAt = default(System.DateTime?), IList<string> excludedSystemClassifications = default(IList<string>), IList<string> includedCustomClassificationRuleNames = default(IList<string>), string description = default(string))
            : base(id, name)
        {
            CreatedAt = createdAt;
