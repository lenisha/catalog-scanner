...
namespace ScannerBabylonService.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AdlsGen2ScanRuleset class.
        /// </summary>
        ...
        /// Initializes a new instance of the AdlsGen2ScanRuleset class.
        /// </summary>
        public AdlsGen2ScanRuleset(string id = default(string), string name = default(string), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? lastModifiedAt = default(System.DateTime?), IList<string> excludedSystemClassifications = default(IList<string>), IList<string> includedCustomClassificationRuleNames = default(IList<string>), string description = default(string), AdlsGen2ScanRulesetPropertiesScanningRule scanningRule = default(AdlsGen2ScanRulesetPropertiesScanningRule))
            : base(id, name)
        {
            CreatedAt = createdAt;
        ...
        public AdlsGen2ScanRulesetPropertiesScanningRule ScanningRule { get; set; }
