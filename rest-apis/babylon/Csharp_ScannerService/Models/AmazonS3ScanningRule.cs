...
namespace ScannerBabylonService.Models
{
    ...
    public partial class AmazonS3ScanningRule
    {
        /// <summary>
        /// Initializes a new instance of the AmazonS3ScanningRule class.
        /// </summary>
        public AmazonS3ScanningRule()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the AmazonS3ScanningRule class.
        /// </summary>
        public AmazonS3ScanningRule(IList<string> fileExtensions = default(IList<string>))
        {
