...
namespace ScannerBabylonService.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AmazonS3ScanRuleset class.
        /// </summary>
        ...
        /// Initializes a new instance of the AmazonS3ScanRuleset class.
        /// </summary>
        public AmazonS3ScanRuleset(string id = default(string), string name = default(string), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? lastModifiedAt = default(System.DateTime?), IList<string> excludedSystemClassifications = default(IList<string>), IList<string> includedCustomClassificationRuleNames = default(IList<string>), string description = default(string), AmazonS3ScanRulesetPropertiesScanningRule scanningRule = default(AmazonS3ScanRulesetPropertiesScanningRule))
            : base(id, name)
        {
            CreatedAt = createdAt;
        ...
        public AmazonS3ScanRulesetPropertiesScanningRule ScanningRule { get; set; }
