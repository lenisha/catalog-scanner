...
/**
 * The PowerBIMsiScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = PowerBIMsiScan.class)
@JsonTypeName("PowerBIMsi")
@JsonFlatten
public class PowerBIMsiScan extends Scan {
    /**
     ...
     * @return the PowerBIMsiScan object itself.
     */
    public PowerBIMsiScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the PowerBIMsiScan object itself.
     */
    public PowerBIMsiScan withWorkers(Integer workers) {
