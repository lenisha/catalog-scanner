...
/**
 * The AzureSqlDatabaseManagedInstanceMsiScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureSqlDatabaseManagedInstanceMsiScan.class)
@JsonTypeName("AzureSqlDatabaseManagedInstanceMsi")
@JsonFlatten
public class AzureSqlDatabaseManagedInstanceMsiScan extends Scan {
    /**
     ...
     * @return the AzureSqlDatabaseManagedInstanceMsiScan object itself.
     */
    public AzureSqlDatabaseManagedInstanceMsiScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AzureSqlDatabaseManagedInstanceMsiScan object itself.
     */
    public AzureSqlDatabaseManagedInstanceMsiScan withWorkers(Integer workers) {
     ...
     * @return the AzureSqlDatabaseManagedInstanceMsiScan object itself.
     */
    public AzureSqlDatabaseManagedInstanceMsiScan withServerEndpoint(String serverEndpoint) {
     ...
     * @return the AzureSqlDatabaseManagedInstanceMsiScan object itself.
     */
    public AzureSqlDatabaseManagedInstanceMsiScan withDatabaseName(String databaseName) {
