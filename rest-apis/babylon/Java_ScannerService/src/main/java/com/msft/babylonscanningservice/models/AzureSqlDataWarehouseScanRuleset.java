...
/**
 * The AzureSqlDataWarehouseScanRuleset model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureSqlDataWarehouseScanRuleset.class)
@JsonTypeName("AzureSqlDataWarehouse")
@JsonFlatten
public class AzureSqlDataWarehouseScanRuleset extends ScanRuleset {
    /**
     ...
     * @return the AzureSqlDataWarehouseScanRuleset object itself.
     */
    public AzureSqlDataWarehouseScanRuleset withExcludedSystemClassifications(List<String> excludedSystemClassifications) {
     ...
     * @return the AzureSqlDataWarehouseScanRuleset object itself.
     */
    public AzureSqlDataWarehouseScanRuleset withIncludedCustomClassificationRuleNames(List<String> includedCustomClassificationRuleNames) {
     ...
     * @return the AzureSqlDataWarehouseScanRuleset object itself.
     */
    public AzureSqlDataWarehouseScanRuleset withDescription(String description) {
