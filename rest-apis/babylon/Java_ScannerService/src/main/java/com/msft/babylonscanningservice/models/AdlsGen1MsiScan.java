...
/**
 * The AdlsGen1MsiScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AdlsGen1MsiScan.class)
@JsonTypeName("AdlsGen1Msi")
@JsonFlatten
public class AdlsGen1MsiScan extends Scan {
    /**
     ...
     * @return the AdlsGen1MsiScan object itself.
     */
    public AdlsGen1MsiScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AdlsGen1MsiScan object itself.
     */
    public AdlsGen1MsiScan withWorkers(Integer workers) {
