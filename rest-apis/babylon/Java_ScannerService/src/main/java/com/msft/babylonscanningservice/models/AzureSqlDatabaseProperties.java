...
/**
 * The AzureSqlDatabaseProperties model.
 */
public class AzureSqlDatabaseProperties extends AzureDataSourceProperties {
    /**
     ...
     * @return the AzureSqlDatabaseProperties object itself.
     */
    public AzureSqlDatabaseProperties withServerEndpoint(String serverEndpoint) {
