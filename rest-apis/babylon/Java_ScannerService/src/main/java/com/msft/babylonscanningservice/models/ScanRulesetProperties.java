...
/**
 * The ScanRulesetProperties model.
 */
public class ScanRulesetProperties {
     ...
     */
    @JsonProperty(value = "excludedSystemClassifications")
    private List<String> excludedSystemClassifications;

    /**
     * The includedCustomClassificationRuleNames property.
     */
    @JsonProperty(value = "includedCustomClassificationRuleNames")
     ...
     * @return the ScanRulesetProperties object itself.
     */
    public ScanRulesetProperties withExcludedSystemClassifications(List<String> excludedSystemClassifications) {
     ...
     * @return the ScanRulesetProperties object itself.
     */
    public ScanRulesetProperties withIncludedCustomClassificationRuleNames(List<String> includedCustomClassificationRuleNames) {
     ...
     * @return the ScanRulesetProperties object itself.
     */
    public ScanRulesetProperties withDescription(String description) {
