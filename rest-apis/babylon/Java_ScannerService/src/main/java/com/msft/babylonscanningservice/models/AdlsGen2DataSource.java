...
/**
 * The AdlsGen2DataSource model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AdlsGen2DataSource.class)
@JsonTypeName("AdlsGen2")
@JsonFlatten
public class AdlsGen2DataSource extends DataSource {
    /**
     ...
     * @return the AdlsGen2DataSource object itself.
     */
    public AdlsGen2DataSource withResourceGroup(String resourceGroup) {
     ...
     * @return the AdlsGen2DataSource object itself.
     */
    public AdlsGen2DataSource withSubscriptionId(String subscriptionId) {
     ...
     * @return the AdlsGen2DataSource object itself.
     */
    public AdlsGen2DataSource withEndpoint(String endpoint) {
