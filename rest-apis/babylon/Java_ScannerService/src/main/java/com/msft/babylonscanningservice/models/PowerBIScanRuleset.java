...
/**
 * The PowerBIScanRuleset model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = PowerBIScanRuleset.class)
@JsonTypeName("PowerBI")
@JsonFlatten
public class PowerBIScanRuleset extends ScanRuleset {
    /**
     ...
     * @return the PowerBIScanRuleset object itself.
     */
    public PowerBIScanRuleset withExcludedSystemClassifications(List<String> excludedSystemClassifications) {
     ...
     * @return the PowerBIScanRuleset object itself.
     */
    public PowerBIScanRuleset withIncludedCustomClassificationRuleNames(List<String> includedCustomClassificationRuleNames) {
     ...
     * @return the PowerBIScanRuleset object itself.
     */
    public PowerBIScanRuleset withDescription(String description) {
