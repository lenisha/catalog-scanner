...
/**
 * The AzureStorageServicePrincipalScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureStorageServicePrincipalScan.class)
@JsonTypeName("AzureStorageServicePrincipal")
@JsonFlatten
public class AzureStorageServicePrincipalScan extends Scan {
    /**
     ...
     * @return the AzureStorageServicePrincipalScan object itself.
     */
    public AzureStorageServicePrincipalScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AzureStorageServicePrincipalScan object itself.
     */
    public AzureStorageServicePrincipalScan withWorkers(Integer workers) {
     ...
     * @return the AzureStorageServicePrincipalScan object itself.
     */
    public AzureStorageServicePrincipalScan withTenantId(String tenantId) {
     ...
     * @return the AzureStorageServicePrincipalScan object itself.
     */
    public AzureStorageServicePrincipalScan withServicePrincipalId(String servicePrincipalId) {
     ...
     * @return the AzureStorageServicePrincipalScan object itself.
     */
    public AzureStorageServicePrincipalScan withServicePrincipalKey(String servicePrincipalKey) {
