...
/**
 * The AdlsGen2ScanRuleset model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AdlsGen2ScanRuleset.class)
@JsonTypeName("AdlsGen2")
@JsonFlatten
public class AdlsGen2ScanRuleset extends ScanRuleset {
    /**
     ...
     * @return the AdlsGen2ScanRuleset object itself.
     */
    public AdlsGen2ScanRuleset withExcludedSystemClassifications(List<String> excludedSystemClassifications) {
     ...
     * @return the AdlsGen2ScanRuleset object itself.
     */
    public AdlsGen2ScanRuleset withIncludedCustomClassificationRuleNames(List<String> includedCustomClassificationRuleNames) {
     ...
     * @return the AdlsGen2ScanRuleset object itself.
     */
    public AdlsGen2ScanRuleset withDescription(String description) {
     ...
     * @return the AdlsGen2ScanRuleset object itself.
     */
    public AdlsGen2ScanRuleset withScanningRule(AdlsGen2ScanRulesetPropertiesScanningRule scanningRule) {
