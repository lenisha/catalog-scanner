...
/**
 * The AzureSqlDataWarehouseConnectionStringScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureSqlDataWarehouseConnectionStringScan.class)
@JsonTypeName("AzureSqlDataWarehouseConnectionString")
@JsonFlatten
public class AzureSqlDataWarehouseConnectionStringScan extends Scan {
    /**
     ...
     * @return the AzureSqlDataWarehouseConnectionStringScan object itself.
     */
    public AzureSqlDataWarehouseConnectionStringScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AzureSqlDataWarehouseConnectionStringScan object itself.
     */
    public AzureSqlDataWarehouseConnectionStringScan withWorkers(Integer workers) {
     ...
     * @return the AzureSqlDataWarehouseConnectionStringScan object itself.
     */
    public AzureSqlDataWarehouseConnectionStringScan withServerEndpoint(String serverEndpoint) {
     ...
     * @return the AzureSqlDataWarehouseConnectionStringScan object itself.
     */
    public AzureSqlDataWarehouseConnectionStringScan withDatabaseName(String databaseName) {
     ...
     * @return the AzureSqlDataWarehouseConnectionStringScan object itself.
     */
    public AzureSqlDataWarehouseConnectionStringScan withUsername(String username) {
     ...
     * @return the AzureSqlDataWarehouseConnectionStringScan object itself.
     */
    public AzureSqlDataWarehouseConnectionStringScan withPassword(String password) {
