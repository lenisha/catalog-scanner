...
/**
 * The AzureCosmosDbScanRuleset model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureCosmosDbScanRuleset.class)
@JsonTypeName("AzureCosmosDb")
@JsonFlatten
public class AzureCosmosDbScanRuleset extends ScanRuleset {
    /**
     ...
     * @return the AzureCosmosDbScanRuleset object itself.
     */
    public AzureCosmosDbScanRuleset withExcludedSystemClassifications(List<String> excludedSystemClassifications) {
     ...
     * @return the AzureCosmosDbScanRuleset object itself.
     */
    public AzureCosmosDbScanRuleset withIncludedCustomClassificationRuleNames(List<String> includedCustomClassificationRuleNames) {
     ...
     * @return the AzureCosmosDbScanRuleset object itself.
     */
    public AzureCosmosDbScanRuleset withDescription(String description) {
