...
/**
 * The AdlsGen2ScanningRule model.
 */
public class AdlsGen2ScanningRule {
    /**
     ...
     * @return the AdlsGen2ScanningRule object itself.
     */
    public AdlsGen2ScanningRule withFileExtensions(List<String> fileExtensions) {
