...
/**
 * The AzureSqlDataWarehouseServicePrincipalScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureSqlDataWarehouseServicePrincipalScan.class)
@JsonTypeName("AzureSqlDataWarehouseServicePrincipal")
@JsonFlatten
public class AzureSqlDataWarehouseServicePrincipalScan extends Scan {
    /**
     ...
     * @return the AzureSqlDataWarehouseServicePrincipalScan object itself.
     */
    public AzureSqlDataWarehouseServicePrincipalScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AzureSqlDataWarehouseServicePrincipalScan object itself.
     */
    public AzureSqlDataWarehouseServicePrincipalScan withWorkers(Integer workers) {
     ...
     * @return the AzureSqlDataWarehouseServicePrincipalScan object itself.
     */
    public AzureSqlDataWarehouseServicePrincipalScan withServerEndpoint(String serverEndpoint) {
     ...
     * @return the AzureSqlDataWarehouseServicePrincipalScan object itself.
     */
    public AzureSqlDataWarehouseServicePrincipalScan withDatabaseName(String databaseName) {
     ...
     * @return the AzureSqlDataWarehouseServicePrincipalScan object itself.
     */
    public AzureSqlDataWarehouseServicePrincipalScan withTenantId(String tenantId) {
     ...
     * @return the AzureSqlDataWarehouseServicePrincipalScan object itself.
     */
    public AzureSqlDataWarehouseServicePrincipalScan withServicePrincipalId(String servicePrincipalId) {
     ...
     * @return the AzureSqlDataWarehouseServicePrincipalScan object itself.
     */
    public AzureSqlDataWarehouseServicePrincipalScan withServicePrincipalKey(String servicePrincipalKey) {
