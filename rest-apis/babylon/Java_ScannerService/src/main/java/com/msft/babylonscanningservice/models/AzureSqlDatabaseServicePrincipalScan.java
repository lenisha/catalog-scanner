...
/**
 * The AzureSqlDatabaseServicePrincipalScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureSqlDatabaseServicePrincipalScan.class)
@JsonTypeName("AzureSqlDatabaseServicePrincipal")
@JsonFlatten
public class AzureSqlDatabaseServicePrincipalScan extends Scan {
    /**
     ...
     * @return the AzureSqlDatabaseServicePrincipalScan object itself.
     */
    public AzureSqlDatabaseServicePrincipalScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AzureSqlDatabaseServicePrincipalScan object itself.
     */
    public AzureSqlDatabaseServicePrincipalScan withWorkers(Integer workers) {
     ...
     * @return the AzureSqlDatabaseServicePrincipalScan object itself.
     */
    public AzureSqlDatabaseServicePrincipalScan withServerEndpoint(String serverEndpoint) {
     ...
     * @return the AzureSqlDatabaseServicePrincipalScan object itself.
     */
    public AzureSqlDatabaseServicePrincipalScan withDatabaseName(String databaseName) {
     ...
     * @return the AzureSqlDatabaseServicePrincipalScan object itself.
     */
    public AzureSqlDatabaseServicePrincipalScan withTenantId(String tenantId) {
     ...
     * @return the AzureSqlDatabaseServicePrincipalScan object itself.
     */
    public AzureSqlDatabaseServicePrincipalScan withServicePrincipalId(String servicePrincipalId) {
     ...
     * @return the AzureSqlDatabaseServicePrincipalScan object itself.
     */
    public AzureSqlDatabaseServicePrincipalScan withServicePrincipalKey(String servicePrincipalKey) {
