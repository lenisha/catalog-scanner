...
/**
 * The AmazonS3ScanningRule model.
 */
public class AmazonS3ScanningRule {
    /**
     ...
     * @return the AmazonS3ScanningRule object itself.
     */
    public AmazonS3ScanningRule withFileExtensions(List<String> fileExtensions) {
