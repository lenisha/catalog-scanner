...
/**
 * The AdlsGen1ServicePrincipalScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AdlsGen1ServicePrincipalScan.class)
@JsonTypeName("AdlsGen1ServicePrincipal")
@JsonFlatten
public class AdlsGen1ServicePrincipalScan extends Scan {
    /**
     ...
     * @return the AdlsGen1ServicePrincipalScan object itself.
     */
    public AdlsGen1ServicePrincipalScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AdlsGen1ServicePrincipalScan object itself.
     */
    public AdlsGen1ServicePrincipalScan withWorkers(Integer workers) {
     ...
     * @return the AdlsGen1ServicePrincipalScan object itself.
     */
    public AdlsGen1ServicePrincipalScan withTenantId(String tenantId) {
     ...
     * @return the AdlsGen1ServicePrincipalScan object itself.
     */
    public AdlsGen1ServicePrincipalScan withServicePrincipalId(String servicePrincipalId) {
     ...
     * @return the AdlsGen1ServicePrincipalScan object itself.
     */
    public AdlsGen1ServicePrincipalScan withServicePrincipalKey(String servicePrincipalKey) {
