...
/**
 * The AzureStorageDataSource model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureStorageDataSource.class)
@JsonTypeName("AzureStorage")
@JsonFlatten
public class AzureStorageDataSource extends DataSource {
    /**
     ...
     * @return the AzureStorageDataSource object itself.
     */
    public AzureStorageDataSource withResourceGroup(String resourceGroup) {
     ...
     * @return the AzureStorageDataSource object itself.
     */
    public AzureStorageDataSource withSubscriptionId(String subscriptionId) {
     ...
     * @return the AzureStorageDataSource object itself.
     */
    public AzureStorageDataSource withEndpoint(String endpoint) {
