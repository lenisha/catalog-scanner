...
/**
 * The AdlsGen2MsiScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AdlsGen2MsiScan.class)
@JsonTypeName("AdlsGen2Msi")
@JsonFlatten
public class AdlsGen2MsiScan extends Scan {
    /**
     ...
     * @return the AdlsGen2MsiScan object itself.
     */
    public AdlsGen2MsiScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AdlsGen2MsiScan object itself.
     */
    public AdlsGen2MsiScan withWorkers(Integer workers) {
