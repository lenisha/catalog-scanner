...
/**
 * The AzureSqlDatabaseConnectionStringScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureSqlDatabaseConnectionStringScan.class)
@JsonTypeName("AzureSqlDatabaseConnectionString")
@JsonFlatten
public class AzureSqlDatabaseConnectionStringScan extends Scan {
    /**
     ...
     * @return the AzureSqlDatabaseConnectionStringScan object itself.
     */
    public AzureSqlDatabaseConnectionStringScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AzureSqlDatabaseConnectionStringScan object itself.
     */
    public AzureSqlDatabaseConnectionStringScan withWorkers(Integer workers) {
     ...
     * @return the AzureSqlDatabaseConnectionStringScan object itself.
     */
    public AzureSqlDatabaseConnectionStringScan withServerEndpoint(String serverEndpoint) {
     ...
     * @return the AzureSqlDatabaseConnectionStringScan object itself.
     */
    public AzureSqlDatabaseConnectionStringScan withDatabaseName(String databaseName) {
     ...
     * @return the AzureSqlDatabaseConnectionStringScan object itself.
     */
    public AzureSqlDatabaseConnectionStringScan withUsername(String username) {
     ...
     * @return the AzureSqlDatabaseConnectionStringScan object itself.
     */
    public AzureSqlDatabaseConnectionStringScan withPassword(String password) {
