...
/**
 * The AzureStorageMsiScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureStorageMsiScan.class)
@JsonTypeName("AzureStorageMsi")
@JsonFlatten
public class AzureStorageMsiScan extends Scan {
    /**
     ...
     * @return the AzureStorageMsiScan object itself.
     */
    public AzureStorageMsiScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AzureStorageMsiScan object itself.
     */
    public AzureStorageMsiScan withWorkers(Integer workers) {
