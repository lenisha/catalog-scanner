...
/**
 * The AmazonS3RoleARNScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AmazonS3RoleARNScan.class)
@JsonTypeName("AmazonS3RoleARN")
@JsonFlatten
public class AmazonS3RoleARNScan extends Scan {
    /**
     ...
     * @return the AmazonS3RoleARNScan object itself.
     */
    public AmazonS3RoleARNScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AmazonS3RoleARNScan object itself.
     */
    public AmazonS3RoleARNScan withWorkers(Integer workers) {
