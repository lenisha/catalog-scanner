...
/**
 * The AdlsGen2AccessKeyScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AdlsGen2AccessKeyScan.class)
@JsonTypeName("AdlsGen2AccessKey")
@JsonFlatten
public class AdlsGen2AccessKeyScan extends Scan {
    /**
     ...
     * @return the AdlsGen2AccessKeyScan object itself.
     */
    public AdlsGen2AccessKeyScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AdlsGen2AccessKeyScan object itself.
     */
    public AdlsGen2AccessKeyScan withWorkers(Integer workers) {
     ...
     * @return the AdlsGen2AccessKeyScan object itself.
     */
    public AdlsGen2AccessKeyScan withAccessKey(String accessKey) {
