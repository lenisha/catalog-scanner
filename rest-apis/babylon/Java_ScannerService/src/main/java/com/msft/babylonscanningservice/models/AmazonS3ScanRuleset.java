...
/**
 * The AmazonS3ScanRuleset model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AmazonS3ScanRuleset.class)
@JsonTypeName("AmazonS3")
@JsonFlatten
public class AmazonS3ScanRuleset extends ScanRuleset {
    /**
     ...
     * @return the AmazonS3ScanRuleset object itself.
     */
    public AmazonS3ScanRuleset withExcludedSystemClassifications(List<String> excludedSystemClassifications) {
     ...
     * @return the AmazonS3ScanRuleset object itself.
     */
    public AmazonS3ScanRuleset withIncludedCustomClassificationRuleNames(List<String> includedCustomClassificationRuleNames) {
     ...
     * @return the AmazonS3ScanRuleset object itself.
     */
    public AmazonS3ScanRuleset withDescription(String description) {
     ...
     * @return the AmazonS3ScanRuleset object itself.
     */
    public AmazonS3ScanRuleset withScanningRule(AmazonS3ScanRulesetPropertiesScanningRule scanningRule) {
