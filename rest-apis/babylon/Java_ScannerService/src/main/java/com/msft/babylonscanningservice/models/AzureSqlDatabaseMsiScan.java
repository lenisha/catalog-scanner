...
/**
 * The AzureSqlDatabaseMsiScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureSqlDatabaseMsiScan.class)
@JsonTypeName("AzureSqlDatabaseMsi")
@JsonFlatten
public class AzureSqlDatabaseMsiScan extends Scan {
    /**
     ...
     * @return the AzureSqlDatabaseMsiScan object itself.
     */
    public AzureSqlDatabaseMsiScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AzureSqlDatabaseMsiScan object itself.
     */
    public AzureSqlDatabaseMsiScan withWorkers(Integer workers) {
     ...
     * @return the AzureSqlDatabaseMsiScan object itself.
     */
    public AzureSqlDatabaseMsiScan withServerEndpoint(String serverEndpoint) {
     ...
     * @return the AzureSqlDatabaseMsiScan object itself.
     */
    public AzureSqlDatabaseMsiScan withDatabaseName(String databaseName) {
