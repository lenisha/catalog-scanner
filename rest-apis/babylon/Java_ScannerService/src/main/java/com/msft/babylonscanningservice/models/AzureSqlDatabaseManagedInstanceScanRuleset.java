...
/**
 * The AzureSqlDatabaseManagedInstanceScanRuleset model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureSqlDatabaseManagedInstanceScanRuleset.class)
@JsonTypeName("AzureSqlDatabaseManagedInstance")
@JsonFlatten
public class AzureSqlDatabaseManagedInstanceScanRuleset extends ScanRuleset {
    /**
     ...
     * @return the AzureSqlDatabaseManagedInstanceScanRuleset object itself.
     */
    public AzureSqlDatabaseManagedInstanceScanRuleset withExcludedSystemClassifications(List<String> excludedSystemClassifications) {
     ...
     * @return the AzureSqlDatabaseManagedInstanceScanRuleset object itself.
     */
    public AzureSqlDatabaseManagedInstanceScanRuleset withIncludedCustomClassificationRuleNames(List<String> includedCustomClassificationRuleNames) {
     ...
     * @return the AzureSqlDatabaseManagedInstanceScanRuleset object itself.
     */
    public AzureSqlDatabaseManagedInstanceScanRuleset withDescription(String description) {
