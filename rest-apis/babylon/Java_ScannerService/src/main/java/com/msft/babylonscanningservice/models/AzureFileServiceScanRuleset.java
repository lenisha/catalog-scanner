...
/**
 * The AzureFileServiceScanRuleset model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureFileServiceScanRuleset.class)
@JsonTypeName("AzureFileService")
@JsonFlatten
public class AzureFileServiceScanRuleset extends ScanRuleset {
    /**
     ...
     * @return the AzureFileServiceScanRuleset object itself.
     */
    public AzureFileServiceScanRuleset withExcludedSystemClassifications(List<String> excludedSystemClassifications) {
     ...
     * @return the AzureFileServiceScanRuleset object itself.
     */
    public AzureFileServiceScanRuleset withIncludedCustomClassificationRuleNames(List<String> includedCustomClassificationRuleNames) {
     ...
     * @return the AzureFileServiceScanRuleset object itself.
     */
    public AzureFileServiceScanRuleset withDescription(String description) {
     ...
     * @return the AzureFileServiceScanRuleset object itself.
     */
    public AzureFileServiceScanRuleset withScanningRule(AzureFileServiceScanRulesetPropertiesScanningRule scanningRule) {
