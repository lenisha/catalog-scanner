...
/**
 * The AzureStorageSasScan model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind", defaultImpl = AzureStorageSasScan.class)
@JsonTypeName("AzureStorageSas")
@JsonFlatten
public class AzureStorageSasScan extends Scan {
    /**
     ...
     * @return the AzureStorageSasScan object itself.
     */
    public AzureStorageSasScan withScanRulesetName(String scanRulesetName) {
     ...
     * @return the AzureStorageSasScan object itself.
     */
    public AzureStorageSasScan withWorkers(Integer workers) {
     ...
     * @return the AzureStorageSasScan object itself.
     */
    public AzureStorageSasScan withSasUri(String sasUri) {
        this.sasUri = sasUri;
        return this;
    }
