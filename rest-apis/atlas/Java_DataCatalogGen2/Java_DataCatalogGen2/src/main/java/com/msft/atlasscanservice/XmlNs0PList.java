...
public class XmlNs0PList {
     ...
     * @return the XmlNs0PList object itself.
     */
    public XmlNs0PList withList(List<Object> list) {
        this.list = list;
        return this;
    }
     ...
     * @return the XmlNs0PList object itself.
     */
    public XmlNs0PList withPageSize(Integer pageSize) {
     ...
     * @return the XmlNs0PList object itself.
     */
    public XmlNs0PList withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
     ...
     * @return the XmlNs0PList object itself.
     */
    public XmlNs0PList withSortType(String sortType) {
     ...
     * @return the XmlNs0PList object itself.
     */
    public XmlNs0PList withStartIndex(Long startIndex) {
     ...
     * @return the XmlNs0PList object itself.
     */
    public XmlNs0PList withTotalCount(Long totalCount) {
