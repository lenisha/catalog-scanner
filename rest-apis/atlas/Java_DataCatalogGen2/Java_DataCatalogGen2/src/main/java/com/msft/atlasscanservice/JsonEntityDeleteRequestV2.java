...
public class JsonEntityDeleteRequestV2 {
    ...
    private List<JsonAtlasObjectId> entities;
     ...
     * @return the JsonEntityDeleteRequestV2 object itself.
     */
    public JsonEntityDeleteRequestV2 withType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the JsonEntityDeleteRequestV2 object itself.
     */
    public JsonEntityDeleteRequestV2 withUser(String user) {
        this.user = user;
        return this;
    }
     ...
     */
    public List<JsonAtlasObjectId> entities() {
     ...
     * @return the JsonEntityDeleteRequestV2 object itself.
     */
    public JsonEntityDeleteRequestV2 withEntities(List<JsonAtlasObjectId> entities) {
