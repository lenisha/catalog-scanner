...
namespace DataCatalogGen2.Models
{
    ...
    /// </remarks>
    public partial class JsonEntityDeleteRequestV2
    {
        /// <summary>
        /// Initializes a new instance of the JsonEntityDeleteRequestV2 class.
        /// </summary>
        public JsonEntityDeleteRequestV2()
        {
            CustomInit();
        }
        ...
        /// "UNKNOWN".</param>
        public JsonEntityDeleteRequestV2(string type = default(string), string user = default(string), IList<JsonAtlasObjectId> entities = default(IList<JsonAtlasObjectId>))
        {
            Type = type;
            User = user;
            Entities = entities;
        ...
        public IList<JsonAtlasObjectId> Entities { get; set; }
