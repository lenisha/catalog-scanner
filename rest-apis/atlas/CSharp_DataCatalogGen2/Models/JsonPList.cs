...
namespace DataCatalogGen2.Models
{
    ...
    /// </remarks>
    public partial class JsonPList
    {
        /// <summary>
        /// Initializes a new instance of the JsonPList class.
        /// </summary>
        public JsonPList()
        {
            CustomInit();
        ...
        public JsonPList(IList<object> list = default(IList<object>), int? pageSize = default(int?), string sortBy = default(string), string sortType = default(string), long? startIndex = default(long?), long? totalCount = default(long?))
        {
            List = list;
            PageSize = pageSize;
            SortBy = sortBy;
